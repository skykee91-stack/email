// 마스터인사이트 블로그 시리즈 4차 — 클로징 (무료 진단)
// 컨셉: "마지막 메일 + 부담 ZERO 무료 진단"

export const MASTERINSIGHT_BLOG_STEP4_SUBJECT = '{사업자명}님, 마지막입니다. 거절해도 괜찮아요'

export const MASTERINSIGHT_BLOG_STEP4_HTML = `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:36px 40px 20px;">
              <h2 style="color:#0F0F0F; font-size:20px; font-weight:700; margin:0 0 16px; line-height:1.4;">
                <span style="color:#8B6F47;">{사업자명}</span>님, 마지막으로 한 번만요.
              </h2>
              <p style="color:#4E5968; font-size:15px; line-height:1.8; margin:0;">
                세 번 메일 드렸는데 답장이 없으셔서<br>
                오늘이 마지막입니다.
              </p>
            </td>
          </tr>
            ...
            <td style="padding:0 40px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#0F0F0F; border-radius:16px;">
                <tr><td style="padding:28px 24px; text-align:center;">
                  <p style="color:#8B6F47; font-size:12px; font-weight:600; margin:0 0 12px; letter-spacing:2.5px;">FREE DIAGNOSIS</p>
                  <p style="color:#ffffff; font-size:19px; font-weight:800; margin:0 0 10px; line-height:1.5;">블로그 무료 진단<br>한 번만 받아보세요</p>
                  <p style="color:rgba(255,255,255,0.7); font-size:13px; margin:0; line-height:1.7;">5분이면 끝, 받아보고 안 맞으면 그만<br>1년 계약 묶여 있어도 취소·환불 도와드림</p>
                </td></tr>
              </table>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="33%" style="text-align:center; padding:18px 8px; background:#FAF8F3; border-radius:12px 0 0 12px;">
                    <p style="color:#8B6F47; font-size:22px; font-weight:800; margin:0;">0원</p>
                    <p style="color:#6B6B6B; font-size:11px; margin:6px 0 0;">진단 비용 무료</p>
                  </td>
                  <td width="33%" style="text-align:center; padding:18px 8px; background:#FAF8F3; border-left:2px solid #fff; border-right:2px solid #fff;">
                    <p style="color:#8B6F47; font-size:22px; font-weight:800; margin:0;">5분</p>
                    <p style="color:#6B6B6B; font-size:11px; margin:6px 0 0;">빠른 진단 시간</p>
                  </td>
                  <td width="33%" style="text-align:center; padding:18px 8px; background:#FAF8F3; border-radius:0 12px 12px 0;">
                    <p style="color:#8B6F47; font-size:22px; font-weight:800; margin:0;">No</p>
                    <p style="color:#6B6B6B; font-size:11px; margin:6px 0 0;">계약 부담 없음</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:0 40px 28px;">
              <p style="color:#4E5968; font-size:15px; line-height:1.8; margin:0;">
                부담 드리려는 게 아니라<br>
                딱 한 가지만 제안드리고 싶어서요.<br><br>
                <strong style="color:#0F0F0F;">블로그 무료 진단 한 번만 받아보세요.</strong><br>
                · 현재 운영 중인 블로그 키워드 분석<br>
                · 매출 키워드 vs 의미 없는 키워드 분류<br>
                · 상위노출 가능한 키워드 추천<br><br>
                5분이면 됩니다. 받아보고 안 맞으면 그만이에요.<br><br>
