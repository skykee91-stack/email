// 마스터인사이트 블로그 시리즈 3차 — 가격 자극 (1년 계약 함정)
// 컨셉: "블로그 대행 1년 계약 절대 하지 마세요"

export const MASTERINSIGHT_BLOG_STEP3_SUBJECT = '{사업자명}님, 블로그 대행 1년 계약 절대 하지 마세요'

export const MASTERINSIGHT_BLOG_STEP3_HTML = `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:36px 40px 20px;">
              <h2 style="color:#0F0F0F; font-size:20px; font-weight:700; margin:0 0 16px; line-height:1.4;">
                <span style="color:#8B6F47;">{사업자명}</span>님, 잠깐만요.
              </h2>
            ...
            <td style="padding:0 40px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#0F0F0F; border-radius:16px;">
                <tr><td style="padding:28px 24px; text-align:center;">
                  ...
                  <p style="color:#ffffff; font-size:19px; font-weight:800; margin:0 0 10px; line-height:1.5;">1년 계약, 절대 먼저 하지 마세요</p>
                  <p style="color:rgba(255,255,255,0.7); font-size:13px; margin:0; line-height:1.7;">매건 결제, 매월 연장<br>안 쓰면 추가 비용 없음</p>
                </td></tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 40px 28px;">
              <p style="color:#4E5968; font-size:15px; line-height:1.8; margin:0;">
                <strong style="color:#0F0F0F;">블로그 대행 1년 계약은 자영업자에게 손해입니다.</strong><br><br>
                다른 대행사는 1년 계약 받고 나면<br>
                글은 올라가는데 매출은 안 보고, 순위 체크도 안 합니다.<br>
                "블로그 효율 없다"는 말이 그래서 나오는 거예요.<br><br>
                마스터인사이트는 <strong style="color:#0F0F0F;">매건 결제, 매월 연장</strong>입니다.<br>
                안 쓰면 추가 비용 없습니다.<br>
                마음에 안 들면 다음 달부터 안 쓰셔도 돼요.<br><br>
                <strong style="color:#0F0F0F;">매번 평가받는 구조라 자신이 있어야 운영합니다.</strong><br>
