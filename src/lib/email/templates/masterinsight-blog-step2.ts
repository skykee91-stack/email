// 마스터인사이트 블로그 시리즈 2차 — 사회증거 (옆집 비교)
// 컨셉: "옆집 {업종}는 블로그를 이렇게 운영해요"

export const MASTERINSIGHT_BLOG_STEP2_SUBJECT = '{사업자명}님, 옆집 {업종}는 블로그를 이렇게 운영해요'

export const MASTERINSIGHT_BLOG_STEP2_HTML = `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:36px 40px 20px;">
              <h2 style="color:#0F0F0F; font-size:20px; font-weight:700; margin:0 0 16px; line-height:1.4;">
                <span style="color:#8B6F47;">{사업자명}</span>님, 또 인사드려요!
              </h2>
              <p style="color:#4E5968; font-size:15px; line-height:1.8; margin:0;">
                {지역} {업종} 사장님 한 분이<br>
                최근에 블로그 대행사를 바꾸셨어요.<br>
                이유가 한 가지가 아니라 셋 다 였습니다.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 40px 28px;">
              <p style="color:#4E5968; font-size:15px; line-height:1.8; margin:0;">
                <strong style="color:#0F0F0F;">왜 옮기셨을까요?</strong><br><br>
                ① <strong style="color:#0F0F0F;">1년 계약 강요가 없음</strong> — 매월 연장이라 묶이지 않음<br>
                ② <strong style="color:#0F0F0F;">매일 오전 자동 순위체크</strong> — 다른 곳은 한 달에 한 번도 안 함<br>
                ③ <strong style="color:#0F0F0F;">안 쓰면 추가 비용 없음</strong> — 쓴 만큼만 결제<br><br>
                <em style="color:#8B6F47; font-style:normal;">* 옮길 때 1년 계약 취소·환불도 도와드렸어요.</em><br><br>
                같은 광고비로 결과가 다릅니다.<br>
                "그동안 왜 묶여 있었지?"라는 말이 그래서 나옵니다.<br><br>
