// 셀포 4차 마지막 - 깔끔한 이별 이메일

export const SELLPO_STEP4_SUBJECT = '{사업자명}님, 마지막으로 한 가지만 여쭤볼게요'
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:36px 40px;">
              <h2 style="color:#191F28; font-size:20px; font-weight:700; margin:0 0 20px; line-height:1.4;">
                <span style="color:#3182F6;">{사업자명}</span>님,<br>마지막으로 인사드려요
              </h2>
              ...
              <p style="color:#4E5968; font-size:15px; line-height:1.8; margin:0 0 20px;">
                혹시 나중에라도 블로그 마케팅 관련해서 도움이 필요하시면<br>
                아래 버튼이나 이 메일에 답장만 주시면 됩니다.<br>
                언제든 안내해드릴게요.
              </p>

              <p style="color:#191F28; font-size:15px; line-height:1.8; margin:0;">
                사업 번창하시길 바랍니다.<br>
                감사합니다.
              </p>
            </td>
